<?php
  ...
  $exp_amt_dc = mysqli_query($con, "SELECT SUM(expense) FROM expenses WHERE user_id = '$userid' AND expensedate >= (CURDATE() - INTERVAL 1 year) GROUP BY expensecategory");
  ...
  // total spent in last year
  $total_spent_last_7_days = mysqli_query($con, "SELECT SUM(expense) FROM expenses WHERE expensedate >= (CURDATE() - INTERVAL 1 year) AND user_id = '$userid'");
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title text-center">Total Transactions in a year</h5>
              </div>
              <div class="card-body">
          ...
          <div class="col-md">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title text-center">Total Spent in a year</h5>
              </div>
              <div class="card-body">
        ...
        <div class="row">
          <div class="col-md">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title text-center">Pie Chart - in a year</h5>
              </div>
              <div class="card-body">
          ...
          <div class="col-md">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title text-center">Bar Chart - in a year</h5>
              </div>
              <div class="card-body">
          ...
          <div class="col-md">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title text-center">Line Graph - in a year</h5>
              </div>
              <div class="card-body">
          ...
          <div class="col-md">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title text-center">Alternative Line Graph - in a year</h5>
              </div>
              <div class="card-body">
        ...
        <div class="row">
          <div class="col-md">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title text-center">Doughnut Chart - in a year</h5>
              </div>
              <div class="card-body">
